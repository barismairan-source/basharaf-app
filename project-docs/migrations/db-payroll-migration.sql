-- ═══════════════════════════════════════════════════════════════════
--  Migration حقوق و دستمزد — فقط جداول جدید
--  روی دیتابیس basharaf (که ۱۳ جدول هسته را دارد) اجرا شود.
--  Idempotent — هیچ جدول هسته‌ای را تغییر نمی‌دهد.
--  همه مبالغ: bigint تومان صحیح (منطبق با هسته).
-- ═══════════════════════════════════════════════════════════════════
