...
> ⚠️ **این سند خیلی قدیمی است (نسخه‌ی 0.9.58، پروژه الان v0.31.0+).** در
> نشست ۲۰۲۶-۰۷-۲۷ تأیید شد اکثر موارد «بحرانی/بالا» این سند (audit log
> عملیات مالی، rate limit OTP، لاگ OTP در production، دکمه‌ی بازنشانی
> اجباری حقوق) از قبل رفع شده‌اند. قبل از اقدام روی هر ادعای این سند،
> حتماً با کد فعلی چک کن. جزئیات در `HANDOFF.md` بخش ۰.
