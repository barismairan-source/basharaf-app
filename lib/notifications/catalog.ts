...
export const RULE_CATALOG: readonly RuleCatalogEntry[] = [
  ...
  {
    key: 'voucher_approved',
    title: 'تأیید برگه‌ی انبار (شخصی)',
    description: 'وقتی برگه‌ی انبار یک کاربر تأیید می‌شود، فقط همان کاربر مطلع می‌شود.',
    category: 'انبار و خرید',
    trigger: 'تأیید یک برگه‌ی انبار — به ثبت‌کننده‌ی همان برگه اطلاع داده می‌شود.',
    channels: [],
    supportsInApp: true,
    thresholdType: null,
    thresholdUnit: null,
