...
| | |
|---|---|
| **نسخه** | `0.9.55-contact-balance-fix2` |
...
| **کار بعدی پیشنهادی** | تست کاربر: (الف) مانده طرف‌حساب در production — باید ۰ باشد (چون هنوز نسیه‌ای نداریم) و در drawer بخش «مبادلات نقدی» همه تراکنش‌ها را نشان دهد (ب) dialog بازنشانی اجباری حقوق (ج) نمای «فروش واقعی» variance با بازه واقعی فروش |
| **بلاک‌شده/منتظر کاربر** | تأیید عملکرد فیکس contact balance جدید (دو بخش جداگانه در drawer). |
