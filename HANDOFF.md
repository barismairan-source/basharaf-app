...
| **دیپلوی** | ✅ V2 کامل روی main + production: env vars تنظیم شده، migration تأیید شد، merge/push انجام شده. پنل Super Admin هم موبایل‌فرندلی شد (commit جدید، هنوز push نشده تا تأیید کاربر). |
| **کار نیمه‌تمام (in-progress)** | — |
| **کار بعدی پیشنهادی** | برای فعال‌کردن ایمیل فرم استخدام: در `/admin/settings/notifications` تب «قوانین»، toggle ایمیل روی «درخواست استخدام جدید» را روشن کن. |
...
<!-- archived to project-docs/handoff-archive.md: 2026-07-14 payroll approve + تأیید نهایی فاز ۱ v0.24.0 + 2026-07-14 فاز امنیتی ۱ + 2026-07-15 استقرار جریان تک‌نشست + 2026-07-15 تست رگرسیون P&L + 2026-07-15 جداسازی E2E + 2026-07-15 notification فاز ۱ + 2026-07-16 Notification Center V2 اولیه -->
