...
| **کار بعدی پیشنهادی** | تست شکاف ۱ توسط کاربر؛ بعد تصمیم اولویت‌بندی UX audit؛ بعد شکاف ۳ variance. |
| **بلاک‌شده/منتظر کاربر** | (۱) تست شکاف ۱ رسپی. (۲) بررسی جدول اولویت‌بندی در `project-docs/INVESTIGATION-ux-consistency-audit.md` و تأیید کدام ماژول‌ها را ابتدا فیکس کنیم. |
